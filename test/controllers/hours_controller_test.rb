...
class HoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hour" do
    assert_difference('Hour.count') do
      post hours_url, params: { hour: { dental: @hour.dental, layout: @hour.layout, medical: @hour.medical, vision: @hour.vision } }
    end
  ...
  test "should update hour" do
    patch hour_url(@hour), params: { hour: { dental: @hour.dental, layout: @hour.layout, medical: @hour.medical, vision: @hour.vision } }
